...
export default class Dev extends Command {
  ...
  static flags = {
    ...
    'persistent-storage': Flags.boolean({
      description: 'Store database in a file instead of in memory',
      env: 'SHOPIFY_PERSISTENT_STORAGE',
      default: false,
    })
  }
  ...
  public async run(): Promise<void> {
    ...
    await dev({
      ...
      notify: flags.notify,
      persistentStorage: flags['persistent-storage'],
    })
  }
}
